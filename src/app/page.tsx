...
import Section02Right from "@/app/02-right/page";
import Section03One from "@/app/03-one/page";
import Section04Two from "@/app/04-two/page";
import Section05Three from "@/app/05-three/page";
...
export default function Home() {
  ...
  useEffect(() => {
    const getSnapTop = (section: HTMLElement) => {
      ...
      // If this section is shorter than viewport, align viewport to section bottom.
